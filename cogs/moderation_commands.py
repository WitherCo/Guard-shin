...
class ModerationCommands(commands.Cog):
    ...
    @commands.has_permissions(ban_members=True)
    @commands.bot_has_permissions(ban_members=True)
    async def unbanuser(self, ctx, *, user_id_or_name):
    ...
    @commands.command(name="purgemessages", aliases=["clearmessages"])
    @commands.has_permissions(manage_messages=True)
    @commands.bot_has_permissions(manage_messages=True)
    async def purge_messages(self, ctx, amount: int, target: typing.Optional[discord.Member] = None):
        """
    ...
    @commands.command(name="timeoutuser", aliases=["muteuser"])
    @commands.has_permissions(moderate_members=True)
    @commands.bot_has_permissions(moderate_members=True)
    async def timeoutuser(self, ctx, member: discord.Member, duration: str, *, reason=None):
        """
    ...
    @commands.command(name="untimeoutuser", aliases=["unmuteuser"])
    @commands.has_permissions(moderate_members=True)
    @commands.bot_has_permissions(moderate_members=True)
    async def untimeoutuser(self, ctx, member: discord.Member, *, reason=None):
    ...
    @commands.command(name="slowmodeset")
    @commands.has_permissions(manage_channels=True)
    @commands.bot_has_permissions(manage_channels=True)
    async def slowmode_set(self, ctx, seconds: typing.Optional[int] = None):

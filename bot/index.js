...
// Import music player switcher
const { initializeMusicPlayer } = require('./commands/music/musicPlayerSwitcher');
...
initializeMusicPlayer()
  .then(result => {
    console.log(`[Music] Initialized music player system. Using ${result.playerType} player.`);
  })
  .catch(error => {
    console.error('[Music] Error initializing music player system:', error);
    console.log('[Music] Continuing with JavaScript music player as fallback.');
  });
